...
class OrderForm
{
  ...
  public function BuildXML()
  {
    ...
    $xml .= 
      '<header>'.
        '<div class="caption"><span>OBJEDNÁVKA PŘEPRAVY</span> č. ' . 
    ...
    */
            ...
            '<form method="post">'.
              ...
              '<table class="inputtable">'.
                ...
                '<tr>'.
                  '<td>Prijem:</td>'.
                  '<td><input '.
                      'type="text" name="oror_prijem" '.
                      'style="width: 100px;"'.
                      'value="' . $this->i_oOrder->GetColumnByName('oror_prijem')->GetValueAsString() . '"/> CZK</td>'.
                '</tr>'.
                '<tr>'.
                  '<td>Výdej:</td>'.
                  '<td><input '.
                      'type="text" name="oror_vydej" '.
                      'style="width: 100px;" '.
                      'value="' . $this->i_oOrder->GetColumnByName('oror_vydej')->GetValueAsString() . '"/> CZK</td>'.
                '</tr>'.
                '<tr>'.
                  '<td>Sml.cena (text):</td>'.
                  '<td><input '.
                      'type="text" name="oror_smlcenatext" maxlength="40" '.
                      'style="width: 150px;" '.
                      'value="' . $this->i_oOrder->GetColumnByName('oror_smlcenatext')->GetValueAsString() . '"/> +DPH (ALL-IN)</td>'.
                '</tr>'.
                '<tr>'.
                  '<td>Bokem komu:</td>'.
                  '<td><input '.
                      'type="text" name="oror_bokemkdo" maxlength="3" style="width: 30px;"'.
                      'value="' . $this->i_oOrder->GetColumnByName('oror_bokemkdo')->GetValueAsString() . '"/></td>'.
                '</tr>'.
                '<tr>'.
                  '<td>Bokem kolik:</td>'.
                  '<td><input '.
                      'type="text" name="oror_bokemcastka" style="width: 100px;"'.
                      'value="' . $this->i_oOrder->GetColumnByName('oror_bokemcastka')->GetValueAsString() . '"/> CZK</td>'.
                '</tr>'.
                '<tr>'.
                  '<td>Bokem pozn.:</td>'.
                  '<td><input '.
                      'type="text" name="oror_bokempozn" maxlength="40"'.
                      'value="' . $this->i_oOrder->GetColumnByName('oror_bokempozn')->GetValueAsString() . '"/></td>'.
                '</tr>'.
                '<tr>'.
                  '<td>Složeno:</td>'.
                  '<td><input '.
                      'type="checkbox" name="oror_isslozeno" '.
                ...
                '<tr>'.
                  '<td>Storno:</td>'.
                  '<td><input '.
                      'type="checkbox" name="oror_isstorno" '.
              ...
              '<table class="inputtable">'.
                ...
                '<tr>'.
                  ...
                  '<td><input '.
                      'type="text" name="oror_factvyd" maxlength="20" '.
                      'value="' . $this->i_oOrder->GetColumnByName('oror_factvyd')->GetValueAsString() . '"/></td>'.
                '</tr>'.
                '<tr>'.
                  '<td>Přijatá faktura:</td>'.
                  '<td><input '.
                      'type="text" name="oror_factprij" maxlength="20" '.
                      'value="' . $this->i_oOrder->GetColumnByName('oror_factprij')->GetValueAsString() . '"/></td>'.
                '</tr>'.
              '</table>'.              
            '</form>'.
          '</div>'.
          ...
          '<div class="blockform" style="width: 98%;">'.
            '<form method="post">'.
              ...
              '<table class="inputtable">'.
                ...
                '</td></tr>'.
                '<tr><td>'.
                  '<input type="text" name="oror_doprfirma" placeholder="Název firmy" maxlength="100" '.
                          'value="' . $this->i_oOrder->GetColumnByName('oror_doprfirma')->GetValueAsString() . '"/>'.
                '</td></tr>'.
                '<tr><td>'.
                  '<input type="text" name="oror_doprulice" placeholder="Ulice" maxlength="100" '.
                          'value="' . $this->i_oOrder->GetColumnByName('oror_doprulice')->GetValueAsString() . '"/>'.
                '</td></tr>'.
                '<tr><td>'.
                  '<input class="uppercase" style="width: 40px;" type="text" name="oror_doprstat" placeholder="Stát" maxlength="3" '.
                          'value="' . $this->i_oOrder->GetColumnByName('oror_doprstat')->GetValueAsString() . '"/> - '.
                  '<input style="width: 70px;" type="text" name="oror_doprpsc" placeholder="PSČ" maxlength="10" '.
                          'value="' . $this->i_oOrder->GetColumnByName('oror_doprpsc')->GetValueAsString() . '"/>'.
                  '<input style="margin-left: 3px; width: calc(100% - 135px)"type="text" name="oror_doprmesto" placeholder="Město" maxlength="100" '.
                    ...
                    '<td>'.
                      '<table>'.
                        '<tbody>'.
                          '<tr>'.
                            '<td>IČ: </td>'.
                            '<td><input type="text" name="oror_dopric" maxlength="10" '.
                              'value="' . $this->i_oOrder->GetColumnByName('oror_dopric')->GetValueAsString() . '"/>'.
                            '</td>'.
                            '<td style="padding-left: 20px">DIČ: </td>'.
                            '<td><input type="text" name="oror_doprdic" maxlength="12" '.
    ...
    $xml .= '<block><html><div class="caption" style="font-size: 15px; padding: 3px;">Přepravy:</div><hr/></html></block>';
    for ($i = 0; $i< count($this->i_oTransports); $i++)
    {                   
      $xml .= '<block><html>';
      $xml .= $this->i_oTransports[$i]->BuildTransportOrderForm($i > 0) . '<hr/>';
      $xml .= '</html></block>';
    }
    $xml .= 
    '<block><html>'.
    ...
    '<block><html>'.
      '<div class="blockform" style="width: 98%;">'.
        '<form method="post">'.
          '<div class="caption">Další info:</div>'.
          '<table class="inputtable">'.
            '<td>'.
              '<input type="text" name="oror_dalsiinfo" maxlength="100" '.
  ...
  public function ProcessAjax()
  {
    ...
    else if ($_POST['formtype'] == 'submit')
    {
      ...
      if ($validdata)
      {
        $STDBR = $this->SaveFullOrderToDB();
        if ($STDBR == SaveToDBResult::OK)
        {
          $this->i_oParentPage->AddAlert('green', 'Objednávka uložena.'); 
          $res .= 'ok';
        }
        else if ($STDBR == SaveToDBResult::InvalidData)
          $validdata = false;
        else
        {
          $res .= 'chyba';
    ...
    else if ($_POST['formtype'] == 'export')
    {
      ...
      {
        $res = 'chyba';
        $this->i_oParentPage->AddAlert('red', 'Selhalo vytvaření PDF.'); 
      }
      else
      {
        $res = 
    ...
    else if ($_POST['formtype'] == 'deltransport')
    {
      ...
      else
      {
        ...
        {
          Logging::WriteLog(LogType::Error, 'OrderForm: DeleteTransport - Transport delete failied.');
  ...
  public function SaveFullOrderToDB()
  {
    ...
    try
    {
      ...
      if ($v_bNew)
        $succes = IncObjcount(true);
      
      if ($succes)
        $succes = $this->i_oOrder->SaveToDB(true);
    
      if ($succes)
      {
        for ($i = 0; $i < count($this->i_oTransports); $i++)
        {
          $succes = $this->i_oTransports[$i]->SaveFullToDB($this->i_oOrder->i_iPK, true);
          if (!$succes) 
          {
      ...
      if ($succes)
        $succes = $this->UpdateOrCreateDeliverer(true);
      
      // updatovat nebo vytvorit zakaznika
      if ($succes)
      {
        $locres = $this->UpdateCustomer($v_bNew, true);
        $succes = $locres == SaveToDBResult::OK;
        if ($locres == SaveToDBResult::InvalidData)
          $v_bInvalidData = true;
        else if ($locres == SaveToDBResult::Error)
  ...
  private function GetCustAddrDatalistXML($a_sTextFilter, $a_sSearchFor)
  {
    ...
    if (!MyDatabase::RunQuery($fields, $SQL, false, $v_aFilters))
    {
      if ($this->i_oParentPage !== null)
        $this->i_oParentPage->AddAlert('red', 'Chyba databáze.');        
      Logging::WriteLog(LogType::Anouncement, '$v_aFilters: ' . print_r($v_aFilters, true));
      return 'error';
    }
    if (count($fields) > 0)
    {
      ...
      {
        $v_sRes .= '<item>';
        $v_sRes .= '<div class="datalistitem" pk="' . $fields[$i]['ORCADR_PK'] . '">';
        $v_sRes .= '<table>';
        $v_sRes .= '<tr><td style="font-weight: bold" colspan="4">' . $fields[$i]['ORCADR_FIRMA'] . '</td></tr>';
        $v_sRes .= '<tr><td colspan="4">' . $fields[$i]['ORCADR_FIRMA2'] . '</td></tr>';
        $v_sRes .= '<tr><td colspan="4">' . $fields[$i]['ORCADR_ULICE'] . '</td></tr>';
        $v_sRes .= '<tr>'.
        ...
        $v_sRes .= '</table>';
        if ($a_sSearchFor == 'nakl')
          $v_sRes .= '<div class="cornerinfo">Nakládek: ' . $fields[$i]['ORCADR_NAKLNUM'] . '</div>';
        else if($a_sSearchFor == 'vykl')
          $v_sRes .= '<div class="cornerinfo">Vykládek: ' . $fields[$i]['ORCADR_VYKLNUM'] . '</div>';
        $v_sRes .= '</div>';
        $v_sRes .= '</item>';
      }
    }
  ...
  public function UpdateOrCreateDeliverer($ExternTransaction)
  {
    ...
    $fields = null;
    if (!MyDatabase::RunQuery($fields, $SQL, $ExternTransaction, 
  ...
  public function UpdateCustomer($NewOrder, $ExternTransaction)
  {
    ...
    for ($i = 0; $i < count($this->i_oTransports); $i++)
    {
      for ($n = 0; $n < 2; $n++)
      {
        ...
        $SQL = 'select orcadr_pk from or_custaddress where'.
          ' orcadr_customer = ? and'.
          ' orcadr_firma = ? and'.
          ' orcadr_psc = ? and'.
          ' orcadr_mesto = ?';
        ...
        {
          Logging::WriteLog(LogType::Error, 'UpdateCustomer() - Error during searching customeraddres pk by company name.');
          return SaveToDBResult::Error;
        }        
  ...
  public function DeletFromDB($ExternTransaction = false)
  {
    $success = true;
    try
    {
      ...
      if ($success)
      {
        for ($i = 0; $i < count($this->i_oTransports); $i++)
        {
          ...
          {
            Logging::WriteLog(LogType::Error, 'OrderForm->DeletFromDB - Failed to Delete transport on index ' . $i);
            $success = false;
            break;            
          }
        }
  ...
  private function Loadtransports($ExternTransaction = false)
  {
    ...
    if (count($fields) == 0)
    {
      Logging::WriteLog(LogType::Error, 'Loadtransports() - No transports found -> unconsistend data.');
      return false;          
    }
    for ($i = 0; $i < count($fields); $i++)
    {
