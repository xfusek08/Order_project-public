  ...
  public function ProcessAjax() 
  {
    if ($_POST['type'] == 'browser' && $this->i_oBrowser !== null)
    {
      if (!$this->i_oBrowser->ProcessAjax())
        $this->AddAlert ('red', 'Chyba při načítání parapetrů pro browser.');
      return true;      
    }
    return false;
  }
  public function AddAlert($a_sColor, $a_sMessgage)
  {
    $this->i_aAlerts[] = new Alert($a_sColor, $a_sMessgage);
  }
...
class Alert
{
  public $i_sMessage;
  public $i_sColor;  
  public function __construct($a_sColor, $a_sMessgage)
  {
    $this->i_sColor = $a_sColor;
    $this->i_sMessage = $a_sMessgage;
